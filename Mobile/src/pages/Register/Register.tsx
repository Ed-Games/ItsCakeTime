  ...
  async function createUser(values: RegisterValues) {
    ...
    await api
      ...
      .catch((err) => {
        ...
        setMessage(
          `O e-mail ${data.email} ou nome ${data.userName} já estão em uso por outra pessoa!`
        );
      });
  }
    ...
    >
          ...
          >
            {({ handleChange, handleSubmit, errors, handleReset }) => (
              ...
              >
                ...
                {errors.name && (
                  <Text style={{ fontSize: 15, color: "red", marginBottom: 5 }}>
                    {errors.name}
                  </Text>
                )}
                ...
                <TouchableOpacity
                  ...
                  onPress={!errors ? (handleReset as any) : () => {}}
      ...
      >
        ...
        <ModalButton onPress={() => setModalVisible(false)}>
          <ModalText style={{ color: "#9553A0" }}>ok</ModalText>
        </ModalButton>
      </ModalView>
    </KeyboardAvoidingView>
  );
