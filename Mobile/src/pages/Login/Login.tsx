  ...
  return (
    ...
    >
      <View style={{ alignItems: "center" }}>
        ...
        {!isKeyboardOpen && <Image style={styles.Image} source={LoginBaker} />}
        ...
        >
          {({ handleChange, handleSubmit, values, errors, handleReset }) => (
            <>
              ...
              {errors.user && (
                <Text
                  style={{ fontSize: 15, color: "yellow", marginBottom: 5 }}
                >
                  {errors.user}
                </Text>
              )}
              ...
              <RectButton
                onPress={() => setForgotPasswdModalVisible(true)}
                style={{ marginTop: 10 }}
              >
              ...
              >
                ...
                <Text style={styles.GoToRegisterTextLink}>Clique aqui</Text>
              </RectButton>
            </>
          )}
        </Formik>
      ...
      <ModalView
        ...
        setStateFunction={setLoginModalVisible}
      >
        <>
          <ModalText>
            Verifique se o usuário e senha estão corretos e tente novamente
          </ModalText>
      ...
      >
        {({ handleChange, handleSubmit, values, errors, handleReset }) => (
          <ModalView
            ...
            isVisible={forgotPasswdmodalVisible}
            setStateFunction={setForgotPasswdModalVisible}
          >
            <>
              <ModalText>
                Sem problema, informe seu email para te ajudarmos a criar uma
                nova
              </ModalText>
              <View style={{ marginTop: 20, alignItems: "center" }}>
                ...
                {errors.email && (
                  <Text
                    style={{ fontSize: 15, color: "red", marginBottom: 10 }}
                  >
                    {errors.email}
                  </Text>
                )}
